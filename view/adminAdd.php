...
<body>
    ...
    <div class="container-fluid">
        ...
        <form method="post" enctype="multipart/form-data" action="../controller/addRecipe.php" class="formBorder" id="recipeForm">
            ...
            <div class="row">
                <div class="col">
                    <button class="btn btn-secondary" type="button" id="createIngredient" onclick="createIngredientFunc()">Add Ingredient</button>
                </div>
            </div>
            <br>
            ...
            <div class="row">
                <div class="col">
                    <button class="btn btn-secondary" type="button" id="createInstruction" onclick="createInstructionFunc()">Add Instructions</button>
                </div>
            </div>
            <br>
            <div class="row">
